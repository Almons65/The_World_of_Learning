...
def fetch_meta(vid):
    try:
        ...
        views = re.search(r'<meta itemprop="interactionCount" content="(\d+)"', html)
        ...
        res[vid] = {"creator": c[:25], "views": v, "date": d}
    except Exception as e:
        res[vid] = {"creator": "Global Archive", "views": "1.2M views", "date": "Unknown"}
